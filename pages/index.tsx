...
const Home: NextPage = () => {
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      toast.success("Tickets purchase successfully!", {
        id: notification,
      });
      console.info("Buying Tickets success", data);
    } catch (error) {
      toast.error("Whoops something went wrong!", {
        id: notification,
      });
      console.error("contract call falure", error);
    }
  };
    ...
    <div className="bg-[#091B18] min-h-screen flex flex-col">
      ...
      {winnings > 0 && (
        <div className="max-w-md md:max-w-2xl lg:max-w-4xl mx-auto mt-5">
          ...
          to-emerald-600 animate-bounce text-center rounded-xl w-full"
          >
        ...
        <div className="stats-container space-y-2">
          <div className="stats-container">
            ...
            <button
             ...
             to-emerald-600 px-10 py-5 rounded-md font-semibold text-white shadow-xl
              ...
              <div className="flex max-w-sm flex-wrap gap-x-2 gap-y-2">
                {Array(userTickets)
                  ...
                  .map((_, index) => (
                    ...
                    rounded-lg flex flex-shrink-0 items-center
      ...
      >
        ...
        <p className="text-xs text-emerald-900 pl-5">
          DISCLAIMER: This project is made for learning and educational purposes
          only. Project is not intended to be a lure to gambling. I am not
          liable for any losses that are incurred or gambling problems may that
          arise. If you are gambling online utilizing information from this
